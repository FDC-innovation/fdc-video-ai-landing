...
export function VeedWaitlist() {
  ...
  return (
    <section className="bg-[#FAFAFA] py-32 px-6 overflow-hidden relative border-t border-[#F4F4F5]" id="waitlist" ref={ref}>
      ...
      <div className="relative z-10 max-w-lg mx-auto text-center">
        ...
        >
          <span className="text-xs font-bold tracking-widest text-[#5A6BFB] uppercase" style={{ fontFamily: "var(--font-inter)" }}>
            Early Access
          </span>
        </motion.div>
